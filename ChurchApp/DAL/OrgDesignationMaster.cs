    ...
    public class OrgDesignationMaster
    {
        ...
        public string InsertOrgDesignationMaster()
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@Position", SqlDbType.NVarChar, 250).Value = position!=null&&position!=""?position:null;
                cmd.Parameters.Add("@Order", SqlDbType.NVarChar, 250).Value = order!=null&&order!=""?order:null;
                cmd.Parameters.Add("@OrgType", SqlDbType.NVarChar, 20).Value = orgType!=null&&orgType!=""?orgType:null;
